...
SubShader {
 ...
 Pass {
  Name "FORWARD"
  LOD 200
  Tags { "LIGHTMODE" = "FORWARDBASE" "RenderType" = "CTI-TreeBark" "SHADOWSUPPORT" = "true" }
  ColorMask RGB 0
  GpuProgramID 60773
Program "vp" {
SubProgram "d3d11 " {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "FORWARD"
  LOD 200
  Tags { "LIGHTMODE" = "FORWARDADD" "RenderType" = "CTI-TreeBark" "SHADOWSUPPORT" = "true" }
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "PREPASS"
  LOD 200
  Tags { "LIGHTMODE" = "PREPASSBASE" "RenderType" = "CTI-TreeBark" }
  GpuProgramID 138012
Program "vp" {
SubProgram "d3d11 " {
"// shader disassembly not supported on DXBC"
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "PREPASS"
  LOD 200
  Tags { "LIGHTMODE" = "PREPASSFINAL" "RenderType" = "CTI-TreeBark" }
  ZWrite Off
  GpuProgramID 223329
Program "vp" {
SubProgram "d3d11 " {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "DEFERRED"
  LOD 200
  Tags { "LIGHTMODE" = "DEFERRED" "RenderType" = "CTI-TreeBark" }
  GpuProgramID 288248
Program "vp" {
SubProgram "d3d11 " {
"// shader disassembly not supported on DXBC"
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "ShadowCaster"
  LOD 200
  Tags { "LIGHTMODE" = "SHADOWCASTER" "RenderType" = "CTI-TreeBark" "SHADOWSUPPORT" = "true" }
  GpuProgramID 380918
Program "vp" {
SubProgram "d3d11 " {
